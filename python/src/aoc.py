...
response = requests.post(
    url=AOC_API_BASE + "packages", headers=request_headers, json=package_creation
)
response.raise_for_status()
...
response = requests.get(
    AOC_API_BASE + "nodes/%s" % package_info["node_id"], headers=request_headers
)
response.raise_for_status()
...
response = requests.put(
    AOC_API_BASE + "packages/%s" % package_info["id"],
    headers=request_headers,
